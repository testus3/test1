...
<img src="https://render.githubusercontent.com/render/math?math={\color{blue}\L = -\sum_{j}[T_{j}ln(O_{j})] + \frac{\lambda W_{ij}^{2}}{2} \rightarrow -ln(O_{c}) + \frac{\lambda W_{ij}^{2}}{2}}"> 
