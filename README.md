...
### 1. Manipulate the data <img src="https://latex.codecogs.com/svg.image?\mathbf{\textbf{fd}_{(398x6)}}" align="center" border="0" alt=" \lim_{a \rightarrow b} " width="33" height="28">
