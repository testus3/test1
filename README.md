...
<img src="https://render.githubusercontent.com/render/math?math={\color{red}\L = -\sum_{j}[T_{j}ln(O_{j})] + \frac{\lambda W_{ij}^{2}}{2} \rightarrow \text{one-hot} \rightarrow -ln(O_{c})}">
